...
$$
  h_i = \sqrt{a_i d_i},
$$
which makes their distribution more nearly symmetric, and then comparing each $h_i$ with a robust estimate of typical gap size, namely the 25% trimmed mean of the $h_i$ values:
$$
...
$$
as approximately standard Gumbel under the null. This gives the approximate upper-tail probability
$$
  p \approx 1 - \exp\!\left(-e^{-t}\right).
$$ {#eq-gap-pvalue}
