...
#| warning: false
dist_kde(oldfaithful$duration, multiplier = 2) |>
...
#| fig.asp: 0.2
oldfaithful |> gg_hdrboxplot(duration, show_anomalies = FALSE) +
...
of |> gg_hdrboxplot(duration, waiting, show_anomalies = FALSE) +
  labs(x = "Duration (seconds)", y = "Waiting time (seconds)")
```
...
of |> gg_hdrboxplot(duration, waiting, show_anomalies = FALSE, scatterplot = TRUE) +
  labs(x = "Duration (seconds)", y = "Waiting time (seconds)")
```
