...
Now, `r english::words(sum(surprisals_prob(of, loo = TRUE) < 0.001))` anomalies are identified, with both of them having infinite LOO surprisals. We can visualize them in an HDR scatterplot, shown in @fig-ofpot2.
