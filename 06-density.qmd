...
@fig-shiraz-surprisal shows the relationship between points and price, with the points colored according to the surprisal probability. The ten blue points are observations with surprisal probabilities less than 0.002 (two are almost overlapping).
