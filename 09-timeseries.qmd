...
The lowest probabilities indicate possible anomalies. Let's look at the most likely anomaly, from series `r s01`. 
...
#| label: pbs_scores3
#| code-fold: false
pbs_anomalies <- pbs_scores |> filter(prob < 0.002)
pbs_anomalies
```
