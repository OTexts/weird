...
The probability that $Y$ lies in the interval $[a,b]$ is given by $\text{Pr}(a \le Y \le b) = \int_a^b f(y)dy = F(b) - F(a)$.
...
$$
  \Pr\left\{ \frac{(M_n - a_n)}{b_n} \leq z \right\} \rightarrow G(z) \quad \text{as} \quad n \to \infty,
$$
...
$$
  \Pr\left\{ \max \{Y_1, \dots, Y_n\} \leq z \right\} = \left[ \Phi(z) \right]^n,
$$
...
$$
  H(y) = \Pr\left \{Y \leq u + y \mid Y > u \right \}
